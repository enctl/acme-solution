package io.acme.registration.test;

import io.acme.registration.ApplicationBootstrap;
...
import io.acme.registration.test.message.MessageReceiver;
...
public class ProfileApplicationTest {
    ...
    public void testProfileRegistration() {
        ...
        try {
            ...
            log.error("Could not open a test server socket for profile registration");
            log.trace("Test profile registration URL is malformed", exception);
            Assert.fail();
        } catch (URISyntaxException exception) {
            log.error("Could not hit profile registration endpoint");
            log.trace("Test profile registration URI is malformed", exception);
            Assert.fail();
